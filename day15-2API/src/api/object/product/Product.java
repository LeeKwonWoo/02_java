...
public class Product {
	 ...
	 * -------------------------------------------------------
	 * 1. get으로 시작
	 * 2. get 뒤에 오는 이름은 접근하려는 멤버변수 이름의 첫 글
	 *    자만 대문자로 하는 낙타표기법
	 * 3. 메소드 매개변수는 없어야 한다.
	...
	public String toString() {
		String strProduct = String.format("제품 정보 [제품코드 : %s, 제품명 : %s" + ", 가격 %,d: , 재고수량 : %d]", pcode, pname, price,
				quantity);
		return strProduct;
	}
