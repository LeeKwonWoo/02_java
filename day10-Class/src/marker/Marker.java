...
public class Marker {
	...
	public void print() {
		if (isNew) {
			System.out.println("번호:"+serial+" "+color+"색은 새 마커입니다.");
		} else {
			System.out.println("번호:"+serial+" "+color+"색은 다 쓴 마커입니다.");
		}
		if (isOpened) {
			System.out.println("번호:"+serial+" "+color+"색은 뚜껑이 열려있습니다.");
		} else {
			System.out.println("번호:"+serial+" "+color+"색은 뚜껑이 닫혀있습니다.");
		}
	}
}
