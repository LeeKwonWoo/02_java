...
/**
 * 서점에서 할 수 있는 여러 기능들
 * 책찾기, 책수정, 신간추가, 채 폐기등의 기능을 테스트 하는 클래스
...
public class BookStoreTest {
	...
	public static void main(String[] args) {
		...
		Book vegitarian = new Book(1,"9788936433598","채식주의자","한강","창비",247,10800,10);
		Book littlePrince = new Book(2,"9791159039690","어린왕자(초판본)","생텍쥐페리","티스토리",150,8820,5);
		Book noDaap = new Book(3,"9791190182645","제 인생에 답이 없어요","선바","위즈덤하우스",192,10800,3);
		Book dduk = new Book(4,"9791196394509","죽고싶지만 떡볶이는 먹고싶어","백세희","흔",208,12420,2);
		Book ax = new Book(5,"9788956055466","책은 도끼다","박웅현","북하우스",348,14400,2);
		// 2. 서점에 도착한 신간 입고
		System.out.println("=====2. 신간 입고 =====");
		kyobo.add(vegitarian);
		...
		Book vegitarian2 = new Book(1,"9788936433598","채식주의자","한강","창비",247,10000,7);
		// (2) 변경된 책 정보를 담은 책 객체를 넘겨서 수정처리
		kyobo.set(vegitarian2);
		// 5. 채식주의자 가격 할인 적용 결과 확인:get
		System.out.println("=====5. 변경 확인 =====");
